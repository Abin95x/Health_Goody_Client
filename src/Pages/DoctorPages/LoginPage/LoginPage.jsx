  ...
  return (
    <>
      <div
        ...
        style={{ backgroundImage: `url(${doctorsignup})` }}
      >
        <div className="hero-overlay bg-opacity-60"></div>
        <div className="hero-content flex flex-col items-center justify-center">
          <div className="card w-full sm:w-96 max-w-sm shadow-2xl bg-base-100">
            <div>
              <br />
            ...
            <form className="card-body" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <h2 className="text-center">Email : doctor@gmail.com</h2>
                <h2 className="text-center">Password : Doctor123</h2>
              </div>
